...
function migrate(args) {
  return (0, _migrator.getMigrator)('migration', args).then(migrator => {
    return (0, _migrator.ensureCollectionSchema)(migrator).then(() => migrator.pending()).then(migrations => {
      const options = {};
...
function migrationStatus(args) {
  _helpers2.default.view.info('Migrations Status\n--------------------------------------------\n');

  return (0, _migrator.getMigrator)('migration', args).then(migrator => {
    return (0, _migrator.ensureCollectionSchema)(migrator).then(() => migrator.executed()).then(migrations => {

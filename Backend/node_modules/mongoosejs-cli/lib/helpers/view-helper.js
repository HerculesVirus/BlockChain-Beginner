...
module.exports = {
  teaser() {
    const versions = ['Node: ' + _index2.default.version.getNodeVersion(), 'CLI: ' + _index2.default.version.getCliVersion(), 'ODM: ' + _index2.default.version.getOdmVersion()];

    this.log();
    this.log(_cliColor2.default.underline.blue('Mongoosee CLI [' + versions.join(', ') + ']'));
    this.log();
  },
  ...
  info(message) {
    this.log(`${_cliColor2.default.underline.blue('INFO:')} ${message}`);
  },

  ok(message) {
    this.log(`${_cliColor2.default.green('SUCCESS:')} ${message}`);
  },
